...
public class hashing {
        ...
        static int size = 431729;
        //this is the size of the hash table - a prime number is best

        static double loadFactor=(double)216555/(double)size;
...
//create the hash table
    ...
    public static void main (String[] args) throws IOException {
      File testFile = new File("/home/ian/dictionary.txt");     //this is where the file to be sorted is loaded from
...
*/
         ...
         {  
          total+=modPow((int)word.charAt(i)+i,103+word.length(),size);          
          total = modPow(total,1,size);           
         }
...
*/
          ...
          for (int i = 0; i < word.length(); i++)
          {
              //System.out.println("i "+ i+" word: "+ word.length());
              total+=(int)word.charAt(i)+modPow(total,power-i,65537);
             
              power--;
              //System.out.println("i "+ i+" word: "+ word.length()+ " Total: "+ total);
     ...
     } // end of getDoubleHashKey method
...
//print out the information for the last 1,000 words only, otherwise it takes quite long and gets annoying
      ...
      }// end of fillLinearProbing method
      ...
      public static void fillQuadraticProbing(){
         ...
         System.out.println("The total number of collisions was "+ totalcollisions);
      }// end of fillQuadraticProbing method
